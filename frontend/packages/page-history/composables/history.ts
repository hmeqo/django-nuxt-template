...
export const usePageHistory = () => {
  const paths = usePiniaSessionStorage<Path[]>('page-history-paths', { default: () => [] })
  const enabledStore = usePiniaLocalStorage<StrBoolean>('page-history-enabled', { default: () => 'true' })
